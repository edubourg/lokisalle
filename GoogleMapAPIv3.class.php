...
class GoogleMapAPI {
    ...
    public function init() {
        ...
        if ($this->includeJs === TRUE) {
            // Google map JS
			$this->content .= '<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDneWwGB0zEIVRcavlmVhvo4ynmquUxbqY&v=3.exp&sensor=false&language=' . $this->lang . '">';
